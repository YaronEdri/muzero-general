...
env_path = os.path.join(project_root, "clutter")
import sys
sys.path.append(env_path)

import gym_env
from gym_env import RoverEnvVacuum
...
class Game(AbstractGame):
    ...
    def __init__(self, seed=None):
        self.env = gym.make("RoverEnvVacuum-v0")
        if seed is not None:
            self.env.seed(seed)
    ...
    def action_to_string(self, action_number):
        ...
        actions = {
            0: "don't move",
            1: "slow forward",
            2: "slow forward - slow rotate",
            3: "slow forward - fast rotate",
            4: "fast forward",
            5: "fast forward - slow rotate",
            6: "fast forward - fast rotate",
            7: "slow rotate",
            8: "fast rotate",
